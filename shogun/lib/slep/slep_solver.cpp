		...
		const slep_options& options)
{
	...
	io::info("Computed lambda = {} * {} = {}",z,lambda_max,z*lambda_max);
	return z*lambda_max;
}
		...
		const slep_options& options)
{
	...
	SG_DEBUG("n_tasks = {}, n_blocks = {}",n_tasks,n_blocks)
	SG_DEBUG("n_nodes = {}",options.n_nodes)
	...
	io::info("Finished {} iterations, objective = {}", iter, func);
